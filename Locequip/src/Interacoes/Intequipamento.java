...
public void adiciona(VariaveisE v1) throws SQLException{
    ...
    String sql = "Insert into equipamento (equipamentoE, descE, precoE, tipoE, porteE, quantidadeE)" 
            + "values (?, ?, ?, ?, ?, ?)";
...
stmt.setString (4,v1.gettipoE());
stmt.setString (5,v1.getporteE());
stmt.setInt (6,v1.getquantidadeE());
...
public List <VariaveisE> getLista () throws SQLException {
 ...
 while (rs.next()){
     ...
     v1.settipoE(rs.getString ("tipoE"));
     v1.setporteE(rs.getString ("porteE"));  
     v1.setquantidadeE(rs.getInt ("quantidadeE"));     
