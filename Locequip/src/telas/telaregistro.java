...
v1.setrgC((Integer.parseInt( TRegistroRG.getText())));
v1.setcpfC((Integer.parseInt(TRegistroCPF.getText())));
v1.setemailC(TRegistroEmail.getText());
v1.setsenhaC(TRegistroSenha.getText());
v1.settelefoneC((Integer.parseInt(TRegistroTelefone.getText())));
